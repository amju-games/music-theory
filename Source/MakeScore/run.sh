...
./makescore --stave-single --transpose 0 --page-width 2.0 --scale 1.0 "[Andante] 4/4 clef-t key-s-0 <c> c4 < <slur> p d4  e4 /< f4 f | g4 > a4 71 /> 72 mf </slur> | <m> 60 64 | 62 65 |" > out.txt
