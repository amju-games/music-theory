...
./makescore --stave-single --transpose 2 --page-width 0.9 --scale 0.5 "[Andante] 4/4 clef-t key-s-0 <c> 60 < <slur> p 62  64 /< 65 f | 67 > 69 71 /> 72 mf </slur> | <m> 60 64 | 62 65 |" > out.txt
