...
# Test width scaling: 2 staves
../makescore --scale 0.5 "page-w 4 4/4 <sb> r | <qq> g3 a3 b3 c4 d4 e4 f4+ g4 a4 b4 c5 d5 e5 f5+ <q> g5 | t sb | stave 4/4 <qq> g3 a3 b3 c4 d4 e4 f4+ g4 a4 b4 c5 d5 e5 f5+ g5 a5 | t <sb> g5 | r |" > out.txt
