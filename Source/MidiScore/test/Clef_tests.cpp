...
TEST_CASE("Interleave clef changes with notes and bar lines", "[Clef]")
{
  ...
  REQUIRE(OutputEvents(events) == "<sb> c3 | c3 | c5 | c5 | ");
  InsertClefs(events, changes);
  REQUIRE(OutputEvents(events) == "clef-b <sb> c3 | c3 | clef-t c5 | c5 | ");
}
...
TEST_CASE("Interleave clef changes, with anacrusis ", "[Clef]")
{
  ...
  InsertBarLines(tpq, TimeSig::TS_4_4, events, numBars, anacrusis);  
  REQUIRE(OutputEvents(events) == "<m> c3 | t c3 c3 | t c3 c5 | t c5 c5 | t c5 | ");
  InsertClefs(events, changes);
  ...
  REQUIRE(OutputEvents(events) == "clef-b <m> c3 | t c3 c3 | t c3 c5 | t c5 c5 | t c5 | ");
}
