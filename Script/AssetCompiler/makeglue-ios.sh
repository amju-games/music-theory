...
for f in *.txt *.png Course/*.txt Image/*.png obj/*.obj obj/*.mtl obj/*.png Gui/*.txt Scene/*.txt font2d/*.txt font2d/ArialRound/* font2d/Dimbo/* font2d/Guido2/* Shaders/gles/*.txt Shaders/opengl/*.txt
do
    echo "Adding file: " $f
